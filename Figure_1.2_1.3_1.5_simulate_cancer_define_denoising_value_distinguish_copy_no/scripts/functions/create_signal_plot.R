  ...
  if (accuracy_annotation) {
    ...
    grid.newpage()
      ...
      if (copy_no_estimates) {
        ...
        # draw signal plot:
        pushViewport(viewport(x = 0.03, y = 0.001, width = 0.97, height = 0.97, 
          just = c("left", "bottom")))
          grid.draw(signal_plot)
        popViewport()
        ...
        for ( e in 1:length(chr_coords$lab_pos) ) {
          pushViewport(
            viewport(
              x = 0.09 + chr_coords$lab_pos[e]/1.25, 
              y = 0.956, width = 0.05, height = 0.05, 
              just = c("left", "bottom")
            )
          )
            if (e==1) {
        ...
        # draw signal plot:
        pushViewport(viewport(x = 0.04, y = 0.001, width = 0.93, height = 0.9, 
          just = c("left", "bottom")))
          grid.draw(signal_plot)
        popViewport()
      ...
      if (copy_no_estimates) {
        ...
        pushViewport(viewport(x = 0.075, y = 0.9, width = 0.05, height = 0.05))
          #grid.rect()
...
#        popViewport()
        ...
        pushViewport(viewport(x = 0.075, y = 0.145, width = 0.05, height = 0.05))
          #grid.rect()
