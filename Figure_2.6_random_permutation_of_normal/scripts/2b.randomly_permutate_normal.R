...
if (
  ...
  saveRDS(epithelial_df, paste0(common_Robject_dir, 
    "/1a.epithelial_df.Rdata"))
  saveRDS(non_epithelial_df, paste0(common_Robject_dir, 
    "/1b.non_epithelial_df.Rdata"))
  saveRDS(infercnv_metadata, paste0(common_Robject_dir, 
  ...
  epithelial_df <- readRDS(paste0(common_Robject_dir, 
    "/1a.epithelial_df.Rdata"))
  non_epithelial_df <- readRDS(paste0(common_Robject_dir, 
    "/1b.non_epithelial_df.Rdata"))
  gene_annotation <- readRDS(paste0(common_Robject_dir, 
    "/1c.gene_annotation.Rdata"))
  infercnv_metadata <- readRDS(paste0(common_Robject_dir, 
    "/1d.metadata.Rdata"))
