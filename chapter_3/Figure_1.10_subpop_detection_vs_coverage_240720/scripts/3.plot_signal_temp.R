...
print(paste0(
  "Downsample proportion = ", as.character(downsample_proportion))
)
...
non_downsampled_dir <- paste0(results_dir, "infercnv/", sample_name, 
  "/", simulation_number, "/no_downsampling/")
