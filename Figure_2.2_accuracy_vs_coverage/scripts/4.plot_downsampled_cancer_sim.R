...
pdf(
  paste0(in_path, "UMI_downsampling_specificity_precision_correlation.pdf"), 
  width = 7, height = 5
)
  print(p)
dev.off()
...
png(
  paste0(in_path, "UMI_downsampling_specificity_precision_correlation.png"), 
  width = 7, height = 5, units = "in", res = 300
)
  print(p)
dev.off()
