...
t_cells_included <- as.logical(args[3])
analysis_mode <- args[4]
permutation_proportion <- args[5]
simulation_number <- as.character(args[6])
...
print(paste0("Include T cells? ", as.character(t_cells_included)))
