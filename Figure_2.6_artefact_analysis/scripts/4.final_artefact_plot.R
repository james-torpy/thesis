...
png(
  paste0(out_dir, "selected_artefact_annotations.png"), 
  height = 8, 
  width = 22,
  res = 300,
  units = "in"
  ...
  grid.newpage()
    ...
    # plot 1:
    pushViewport(viewport(x = 0.5, y = 0.85, width = 0.97, height = 0.18))
      #grid.rect()
      # plot label:
      pushViewport(viewport(x = 0.05, y = 0.5, width = 0.08, height = 0.4))
        #grid.rect()
        grid.text(paste0(remove_cell_type_labels[1], "\nremoved"), , gp=gpar(fontsize=20, fontface = "bold"))
      popViewport()
    ...
    # plot 2:
    pushViewport(viewport(x = 0.5, y = 0.66, width = 0.97, height = 0.18))
      #grid.rect()
      # plot label:
      pushViewport(viewport(x = 0.05, y = 0.5, width = 0.08, height = 0.4))
        #grid.rect()
    ...
    # plot 3:
    pushViewport(viewport(x = 0.5, y = 0.47, width = 0.97, height = 0.18))
      #grid.rect()
      # plot label:
      pushViewport(viewport(x = 0.05, y = 0.5, width = 0.08, height = 0.4))
        #grid.rect()
    ...
    # plot 4:
    pushViewport(viewport(x = 0.5, y = 0.28, width = 0.97, height = 0.18))
      #grid.rect()
      # plot label:
      pushViewport(viewport(x = 0.05, y = 0.5, width = 0.08, height = 0.4))
        #grid.rect()
    ...
    # plot 5:
    pushViewport(viewport(x = 0.5, y = 0.09, width = 0.97, height = 0.18))
      #grid.rect()
      # plot label:
      pushViewport(viewport(x = 0.05, y = 0.5, width = 0.08, height = 0.4))
        #grid.rect()
    ...
    pushViewport(viewport(x = 0.555, y = 0.95, width = 0.85, height = 0.07))
      ...
      for ( e in 1:length(plot_data[[1]]$chr_data$lab_pos) ) {
        if (e==1) {
          pushViewport(viewport(x = plot_data[[1]]$chr_data$lab_pos[e], y = 0.5, width = 0.01, height = 0.5))
            grid.text(names(plot_data[[1]]$chr_data$lab_pos)[e], gp=gpar(fontsize=16, fontface = "bold"))
          popViewport()
        } else if (e==21) {
          pushViewport(viewport(x = plot_data[[1]]$chr_data$lab_pos[e], y = 0.9, width = 0.01, height = 0.5))
            grid.text(gsub("chr", "", names(plot_data[[1]]$chr_data$lab_pos)[e]), gp=gpar(fontsize=16, fontface = "bold"))
          popViewport()
        } else {
          pushViewport(viewport(x = plot_data[[1]]$chr_data$lab_pos[e], y = 0.5, width = 0.01, height = 0.5))
            grid.text(gsub("chr", "", names(plot_data[[1]]$chr_data$lab_pos)[e]), gp=gpar(fontsize=16, fontface = "bold"))
